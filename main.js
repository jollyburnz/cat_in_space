...
bb_main_MyGame.prototype.bbOnCreate=function(){
	...
	this.bbbg=bb_graphics_LoadImage("asteroidgame/cat-bg.png",1,bb_graphics_Image_DefaultFlags);
...
bb_main_MyGame.prototype.bbOnRender=function(){
	...
	if((this.bbship)!=null){
		...
		bb_graphics_DrawText("Score: "+String(bb_main_MyGame_score),10.000000,10.000000,0.000000,0.000000);
		bb_invalidaterect_InvalidateRect_Add(0,0,100,25);
	}else{
		bb_graphics_DrawText("C A T _ I N _ S P A C E !",10.000000,10.000000,0.000000,0.000000);
		bb_graphics_DrawText("YOUR SCORE: "+String(bb_main_MyGame_score),10.000000,50.000000,0.000000,0.000000);
		bb_graphics_DrawText("Press X to Start new Game",10.000000,75.000000,0.000000,0.000000);
		bb_graphics_DrawText("Instructions: Arrow Keys to move, X to fire!",10.000000,100.000000,0.000000,0.000000);
		bb_invalidaterect_InvalidateRect_Add(0,0,370,125);
	}
...
bb_main_MyGame.prototype.bbOnLoading=function(){
	...
	bb_graphics_DrawText("Loading...",10.000000,10.000000,0.000000,0.000000);
	return 1;
}
...
function bb_soundplayer_SoundPlayer_Init(){
	bb_soundplayer_SoundPlayer_soundLaser=bb_audio_LoadSound("asteroidgame/meow.wav");
